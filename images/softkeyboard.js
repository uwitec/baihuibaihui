...
eval(docStyle + objectXY + styleDoc + vert + "=" + y);
	...
	//if(NS) {window.captureEvents(Event.MOUSEDOWN);
...
document.write ('    <DIV align=center id=\"softkeyboard\" name=\"softkeyboard\" style=\"position:absolute; left:280px; top:380px; width:500px; z-index:180;display:none\">');
document.write ('  <table width=\"340\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"1\" bgcolor=\"#FF9900\">');
document.write ('    <FORM name=Calc action=\"\" method=post autocomplete=\"off\">');
document.write ('      <INPUT type=hidden value=ok name=action2>');
document.write ('      <tr> ');
document.write ('        <td align=\"left\" bgcolor=\"#FF9900\" align=\"center\"> <INPUT class=button type=password size=20 value=\"\" name=password> ');
